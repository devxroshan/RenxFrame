...
const NotAvailable = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <>
      {windowSize.width && windowSize.width <= TABLET_SCREEN ? (
        <div className="md:hidden flex items-center justify-center min-h-screen bg-linear-to-br from-[#0f0f0f] via-[#111827] to-black text-white px-6">
          <div className="max-w-md text-center space-y-6">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              This application is optimized for desktop experience. Please use a
              device with a larger screen (greater than 768px width).
            </p>
