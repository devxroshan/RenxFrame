    ...
    <main className="w-screen h-screen flex items-center justify-center select-none">
      <div className="bg-secondary-bg flex px-3 py-3 gap-4 w-[60vw] h-[70vh] rounded-xl border border-primary-border">
        ...
        <div className="w-[60%] h-full flex flex-col items-start justify-start gap-4">
          ...
          <Link href="/forgot-password" className="text-xs text-primary-blue font-medium hover:underline ml-auto">Forgot Password?</Link>

          <Button variant={ButtonVariant.PRIMARY} text="Login" />
          ...
          <div className="flex flex-col gap-4 w-full items-center justify-center">
            <Button variant={ButtonVariant.SECONDARY_OUTLINE} text="Login with Google" />
            <div>
                <span className="text-sm font-semibold">Don't have an account? </span>
                <Link href="/signup" className="text-sm text-primary-blue font-medium hover:underline">Sign Up</Link>
            </div>
          </div>
        </div>
      </div>
